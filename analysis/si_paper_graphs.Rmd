...
ggplot(data = agg.data, 
       aes(x=type, y=prop.corr, fill=Age)) +
  geom_bar(stat="identity", position = position_dodge())  + geom_errorbar(limits, position=dodge)+
  ylab("Proportion correct") + 
  xlab("Trial Type") +
  scale_fill_brewer(palette="Set3") + facet_grid(~implicature_type, scale="free_x") + geom_hline(yintercept = .5, linetype = "dashed")
```
